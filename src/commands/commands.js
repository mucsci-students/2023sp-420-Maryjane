...
const { highScoreCommand } = require("./highScoreCommand.js");

module.exports = { load, save, promptSave, guess, generateHint, generateTwoLetterHint, newPuzzle, calculatePoints,newPuzzleFromBase, highScoreCommand, shuffle };
