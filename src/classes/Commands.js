...
class Commands {
  ...
  static showPuzzle(GameManager) {
    ...
    console.log("%c    %s\t    %s\n\n%s\t%c%s%c\t%s\n\n    %s\t    %s", normalStyle, GameManager.currentPuzzle[0], GameManager.currentPuzzle[1], GameManager.currentPuzzle[2], requiredStyle, GameManager.currentPuzzle[3], normalStyle, GameManager.currentPuzzle[4], GameManager.currentPuzzle[5], GameManager.currentPuzzle[6]);
  }
